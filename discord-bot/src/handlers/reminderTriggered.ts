...
export const buildReminderTriggeredMessage: IntegrationHandler<ReminderTriggeredInput | Record<string, unknown>, ReminderTriggeredOutput, DiscordBotConfig> = async (input, context) => {
  try {
